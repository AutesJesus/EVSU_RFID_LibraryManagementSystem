...
$user_id = staff_current_user_id();
$user_role = staff_current_role();
$role_label = staff_role_label();
$role_sql = "role IN ('faculty', 'librarian')";
        ...
        <main class="admin-main">
            <div class="container">
                <header class="admin-topbar dashboard-topbar profile-topbar">
                    <div>
                        <p class="dashboard-kicker"><?= h($role_label) ?> / My profile</p>
