...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'update_profile') {
            ...
            $stmt = $pdo->prepare('UPDATE users SET otp_enabled = :enabled WHERE id = :id AND role = \'student\'');
...
<body class="dashboard-page profile-page student-portal-page">
            ...
            <div class="modal-body modal-body-account">
                ...
                <div class="profile-modal-pane" id="accountTabPassword" role="tabpanel" hidden>
                    <form method="post" action="" id="settingsPasswordForm">
                        ...
                        <div class="password-requirements" id="studentPasswordRequirements">
    ...
    <script>
        (function () {
            ...
            // Password requirements validation for student
            const newPasswordInput = document.getElementById('new_password');
            const passwordRequirements = document.getElementById('studentPasswordRequirements');
